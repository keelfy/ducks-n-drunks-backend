...
@Table(name = "armor_type_tab")
public class ArmorType {

    @Id
    @SequenceGenerator(name = "armorTypeIdSeq", sequenceName = "armor_type_id_seq", allocationSize = 1)
    @GeneratedValue(generator = "armorTypeIdSeq", strategy = GenerationType.SEQUENCE)
    ...
    @ElementCollection
    @CollectionTable(name = "armor_type_translation_tab", joinColumns = @JoinColumn(name = "armor_type_id", referencedColumnName = "id"))
