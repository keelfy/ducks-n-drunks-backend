...
@Table(name = "damage_type_tab")
public class DamageType {

    @Id
    @SequenceGenerator(name = "damageTypeIdSeq", sequenceName = "damage_type_id_seq", allocationSize = 1)
    @GeneratedValue(generator = "damageTypeIdSeq", strategy = GenerationType.SEQUENCE)
    ...
    @ElementCollection
    @CollectionTable(name = "damage_type_translation_tab", joinColumns = @JoinColumn(name = "damage_type_id", referencedColumnName = "id"))
